...
function crearClaseMascota() {
  class Mascota {
    ...
    getActividades() {
      ...
      // Tu código aca:
      const SoloActividad = this.actividades.map((actividad) => actividad.actividad) ;
    ...
    getFrecuencia(actividad) {
      ...
      // Tu código aca:
      const actividadObjeto = this.actividades.find((actividadObjeto) => actividad === actividad)
      return actividadObjeto.frecuencia
    };
